...
if(ASSETBRIDGE_COMMAND STREQUAL "batch" AND DEFINED ASSETBRIDGE_BATCH_INPUTS)
    string(REPLACE "|" ";" assetbridge_batch_inputs "${ASSETBRIDGE_BATCH_INPUTS}")
    foreach(assetbridge_batch_input IN LISTS assetbridge_batch_inputs)
        list(APPEND assetbridge_arguments "--input" "${assetbridge_batch_input}")
    endforeach()
elseif(DEFINED ASSETBRIDGE_INPUT)
    list(APPEND assetbridge_arguments "${ASSETBRIDGE_INPUT}")
endif()
if(DEFINED ASSETBRIDGE_TARGET)
    if(ASSETBRIDGE_COMMAND STREQUAL "convert" OR ASSETBRIDGE_COMMAND STREQUAL "batch")
...
if(DEFINED ASSETBRIDGE_VALIDATE_JSON)
    ...
    if(ASSETBRIDGE_COMMAND STREQUAL "batch"
        AND NOT ASSETBRIDGE_VALIDATE_JSON STREQUAL "batch_argument_error")
        list(APPEND validator_arguments
            "${ASSETBRIDGE_EXPECTED_BATCH_STATUS}"
            "${ASSETBRIDGE_OUTPUT}")
        if(DEFINED assetbridge_batch_inputs)
            list(APPEND validator_arguments ${assetbridge_batch_inputs})
        endif()
    endif()
